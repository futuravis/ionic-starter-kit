...
PATTERN="<(ion-button|ion-label|ion-input|ion-textarea|ion-select|ion-toggle|ion-chip|ion-badge|ion-avatar|ion-segment|ion-segment-button|ion-range|ion-searchbar)\b"
